...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      try {
        ...
        const res = await fetch("http://vijeta-api.onrender.com/api/admin/");
  ...
  const updateAdminProfile = async () => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/admin/update/${adminData.admin_id}`, {
        method: "PUT",
      ...
      if (res.ok) {
        // Refresh admin data
        const adminRes = await fetch("http://vijeta-api.onrender.com/api/admin/");
  ...
  const changePassword = async () => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/admin/password/${adminData.admin_id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          oldPassword: oldPass,
  ...
  const fetchNextRollNo = async () => {
    try {
      const res = await fetch("http://vijeta-api.onrender.com/api/students/next-roll-no");
      const data = await res.json();
  ...
  const fetchStudents = async () => {
    try {
      const res = await fetch("http://vijeta-api.onrender.com/api/students/with-results");
      const data = await res.json();
  ...
  const fetchExams = async () => {
    try {
      const res = await fetch("http://vijeta-api.onrender.com/api/exams");
      const data = await res.json();
      setExams(data);
    } catch (err) {
      console.log(err);
  ...
  const handleDeleteExam = async (examId) => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/exams/${examId}`, {
        method: "DELETE"
      });
      if (res.ok) {
  ...
  const handleUpdateExam = async () => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/exams/${editingExam.exam_id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          exam_name: examName,
  ...
  const fetchResults = async () => {
    try {
      const res = await fetch("http://vijeta-api.onrender.com/api/admin-results");
      const data = await res.json();
      if (Array.isArray(data)) {
        setResults(data);
      } else {
  ...
  const fetchResultsByExamType = async (examType) => {
    try {
      const url = examType === 'all' 
        ? "http://vijeta-api.onrender.com/api/admin-results"
        : `http://vijeta-api.onrender.com/api/admin-results/by-exam-type/${examType}`;
  ...
  const viewResultDetails = async (attemptId) => {
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/admin-results/${attemptId}`);
      const data = await res.json();
  ...
  const resetPassword = async (id) => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/students/reset-password/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const deleteStudent = async (id) => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/students/delete/${id}`, {
        method: "DELETE"
      });
  ...
  const updateStudent = async () => {
    ...
    try {
      const res = await fetch(`http://vijeta-api.onrender.com/api/students/update/${editStudent.student_id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const addStudent = async () => {
    ...
    try {
      const res = await fetch("http://vijeta-api.onrender.com/api/students/add", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          student_name: sName,
  ...
  const createExam = async () => {
    ...
    try {
      console.log("Starting API call to http://vijeta-api.onrender.com/api/exams/add");
      console.log("Request method: POST");
      console.log("Request body type: FormData");
      
      const res = await fetch("http://vijeta-api.onrender.com/api/exams/add", {
        method: "POST",
        body: formData,
